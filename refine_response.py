...
if __name__ == "__main__":
    ...
    generated_response = json.load(open('response_gen/0903192711_gpt-4.1_inspired2_train_GPT_response.json', 'r', encoding='utf-8'))
    eval_gen_response = json.load(open('evaluation/gpt_eval/0903233707_gpt-4.1_result_inspired2_train_gpt4.1-response_scoringP.json', 'r', encoding='utf-8'))
